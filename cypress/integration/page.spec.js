...
describe('', () => {
  ...
  describe('Adding a todo', () => {
    ...
    describe('after form submition before response is received', () => {
      beforeEach(() => {
        page.mockCreate();
        page.pauseTimers();
        page.newTodoField().type('Test Index{enter}');
      });
      ...
      it('should keep entered text', () => {
        page.newTodoField().should('have.value', 'Test Index');
      });
      ...
      it('should show a temp TodoItem with correct title', () => {
        todos.assertTitle(5, 'Test Index');
      });
  ...
  describe('Individual Index Deletion', () => {
